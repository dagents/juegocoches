...
export default async function ProponerPage() {
  ...
  const proposalsOpen = isBeforeMadridNoon();
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">
              ...
              evaluará tu propuesta al instante.
            </p>
          </div>

          {!proposalsOpen ? (
            <div className="space-y-4">
              <div className="p-4 rounded-xl border bg-yellow-900/20 border-yellow-700/50">
                <p className="text-sm text-gray-300">
                  Las propuestas de mejora se aceptan de 00:00 a 12:00 (hora Madrid).
                  A partir de las 12:00 solo se puede votar.
                </p>
              </div>
              <Link
                href="/poll"
            ...
            <div className="space-y-4">
              ...
              >
                <p className="text-sm text-gray-300 mb-2">
                  Ya has propuesto una mejora hoy:
                </p>
