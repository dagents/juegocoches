...
import { castVote } from "@/actions/votes.actions";
...
export default function VoteButton({
  ...
  const disabled = !isLoggedIn || hasVotedToday || isOwnIdea || isPending;
  ...
  if (isOwnIdea) tooltip = "No puedes votar tu propia idea";
